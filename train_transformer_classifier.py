...
PREPROCESSED_DATASET_PATH = "preprocessed_multimodal_data/"
# --- NEW: Saving to a v4 model to reflect the new feature set ---
MODEL_SAVE_PATH = "models/transformer_multimodal_classifier_v4.pth"
...
# Pose Features (82) + Shuttle Features (7) = 89
INPUT_SIZE = 89
